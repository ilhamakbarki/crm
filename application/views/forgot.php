...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-logo">
			<a href="<?=base_url('login')?>"><b>Lupa</b> Password</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			...
			<form action="<?=base_url('login/auth')?>" id="form-login" method="post">
				<div class="form-group has-feedback">
					<input type="text" name="uid" id="uid" class="form-control" placeholder="Email">
					<span class="glyphicon glyphicon-user form-control-feedback"></span>
				</div>
				<div class="row">
					<!-- /.col -->
					<div class="col-xs-12">
						<a id="masuk" class="btn btn-primary btn-block btn-flat">Kirim</a>
						<p id ="status"></p>
					</div>
					<!-- /.col -->
				</div>
